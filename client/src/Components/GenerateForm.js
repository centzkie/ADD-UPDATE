    ...
    <div className="form">
      ...
      <form action="" className="newform" onSubmit={validation}>
        <div className="transactions">
          ...
          <select name="transactions" id="transactions" on onChange={(e) =>{
        ...
        {error?
        <label>Please fill the transactions ! </label>:""}

        <div className="email">
          <label htmlFor="Email" className="label">
            Email<span style={colorReq}>*</span>
          </label>
          <input type="email" required placeholder="Ex. Juan Cruz@yahoo.com" onChange={(event) => {setEmail(event.target.value);}}/>
        </div>
        {error?
        ...
        <div className="input-name">
          ...
          <input enabled type="text" required placeholder="Ex. Juan Cruz" onChange={(event) => {setName(event.target.value);}}/>
        </div>
        {error?
